...
import { log, logError, makeDir } from "./common.js";
...
function getTaskConfig(task_path_config){
    const context = {
        ...
        currentTask: null,
        browser_task_config: {},
        task_path_config: task_path_config
    }
    ...
    return{
        ...
        load_libraries: currentTask.load_libraries,
...
async function getTaskConfigBrowser(config, task_path_config){
    ...
    await page.goto(
        path.join( config.path_to_folder, "empty_page.html")
    );
